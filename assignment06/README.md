...
### Process of Project
The process of this project began from low-fidelity wireframes that I had made in Assignment 5 where I also detailed the user flow. I had drawn all of the wireframes on my iPad, so none of the dimensions were exact and a lot of the details were missing. Also, my wireframes were all designed as a desktop version while this project will be the mobile version of my website, so I had to redesign it before actually mocking up the design in Figma. After I mocked up my design, I tested multiple variations of it with regards to layout, typography, and color.
### Purpose of Interface Design
The purpose of interface design is to create a digital representation that ensures that the functionality of the website meshes with the aesthetics, so that all the features and content can be displayed in a comprehensible manner. This design takes what was drawn during the low-fidelity stages and further advances all of the different elements by specifying typography, colors, layout, etc. Interface design can also allow designers to understand user preferences through feedback and find ways to facilitate user interaction. By working with all these design variations, I can ensure that my design would be accessible to the general public and that it could actually carry out the purpose of my project.
### Initial Wireframe
